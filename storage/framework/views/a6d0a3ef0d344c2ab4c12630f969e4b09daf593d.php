...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="<?php echo e(route('admin.tag.create')); ?>">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            ALL TAGS
                            <span class="badge bg-blue"><?php echo e($tags->count()); ?></span>
                        </h2>
                    </div>
                    <div class="body">
                                    ...
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo e(route('admin.tag.edit',$tag->id)); ?>" class="btn btn-info waves-effect">
                                                    <i class="material-icons">edit</i>
                                                </a>
                                                <button class="btn btn-danger waves-effect" type="button" onclick="deleteTag(<?php echo e($tag->id); ?>)">
